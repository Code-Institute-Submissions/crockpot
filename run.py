...
def search():
    ...
    # Split into recipe name and recipe ingredients
    query_split = query.split('&')
    query_recipe = query_split[0]
    query_ingreds = query_split[1]
    if len(query_ingreds) > 0:
        query_ingreds = query_ingreds.rstrip().split(' ')
